...
export const _fetchPoolChainValues = async (
  ...
  const tokenAddress = prizePoolContracts.token.address // In BNB pool with get 0x0000000000000000000000000000000000000000
  ...
  try {
    ...
    const { prizePool, prizeStrategy, sponsorship, ticket, cToken, reserve } = await batch(
      provider,
      ...batchRequests
    )
    ...
    // console.error(e)
    console.log('_fetchPoolChainValues: ', e)
